...
This chapter introduces the options for post-processing the results
calculated by the various Fedem solvers.
...
In Fedem, post-processing means evaluating the data collected from the mechanism
analysis (see \refChapter{mechanism-analysis}{Mechanism Analysis}).
The options for post-processing are graphing and animating.
...
selecting \textbf{Show Animation Controls...} on the \textbf{Results} menu.
