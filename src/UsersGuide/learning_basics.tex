...
\Note{The Origin tab for Triads, Parts and Joints, as well as the
Center of Gravity tab for Generic Parts, do not update during multi-selection.
This is mainly due to implementational reasons.}
